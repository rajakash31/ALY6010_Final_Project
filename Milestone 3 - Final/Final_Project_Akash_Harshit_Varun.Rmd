...
<FONT SIZE = 2, COLOR = " #668203"><B>NULL HYPOTHESIS, H0 : </B></FONT>True Means of the Fuel and Max-Power groups are same.  
<FONT SIZE = 2, COLOR = " #668203"><B>ALTERNATE HYPOTHESIS, H1 : </B></FONT>True Means of the Fuel and Max-Power groups are not same.  
...
<FONT SIZE = 2, COLOR = " #A11515"><B>Observation - </B></FONT>
Since, the p-value of our ANOVA test is less than our alpha = 0.05, we can reject the Null Hypothesis of the test. 
This means that we have sufficient evidence to say that True Means of the Fuel and Max-Power groups are not same in the data set.  

<FONT SIZE = 2, COLOR = " #668203"><B>NULL HYPOTHESIS, H0 : </B></FONT>True Means of the Fuel and Engine groups are same.  
<FONT SIZE = 2, COLOR = " #668203"><B>ALTERNATE HYPOTHESIS, H1 : </B></FONT>True Means of the Fuel and Engine groups are not same.  
...
<FONT SIZE = 2, COLOR = " #A11515"><B>Observation - </B></FONT>
Since, the p-value of our ANOVA test is less than our alpha = 0.05, we can reject the Null Hypothesis of the test. 
This means that we have sufficient evidence to say that True Means of the Fuel and Engine groups are not same in the data set.  

<FONT SIZE = 2, COLOR = " #668203"><B>NULL HYPOTHESIS, H0 : </B></FONT>True Means of the Fuel and Mileage groups are same.  
<FONT SIZE = 2, COLOR = " #668203"><B>ALTERNATE HYPOTHESIS, H1 : </B></FONT>True Means of the Fuel and Mileage groups are not same.  
...
<FONT SIZE = 2, COLOR = " #A11515"><B>Observation - </B></FONT>
Since, the p-value of our ANOVA test is less than our alpha = 0.05, we can reject the Null Hypothesis of the test. 
This means that we have sufficient evidence to say that True Means of the Fuel and Mileage groups are not same in the data set.  

<FONT SIZE = 2, COLOR = " #668203"><B>NULL HYPOTHESIS, H0 : </B></FONT>True Means of the Fuel and Kilometers-Driven groups are same.  
<FONT SIZE = 2, COLOR = " #668203"><B>ALTERNATE HYPOTHESIS, H1 : </B></FONT>True Means of the Fuel and Kilometers-Driven groups are not same.  
...
<FONT SIZE = 2, COLOR = " #A11515"><B>Observation - </B></FONT>
Since, the p-value of our ANOVA test is less than our alpha = 0.05, we can reject the Null Hypothesis of the test. 
This means that we have sufficient evidence to say that True Means of the Fuel and Kilometers-Driven groups are not same in the data set.  

<FONT SIZE = 2, COLOR = " #668203"><B>NULL HYPOTHESIS, H0 : </B></FONT>True Means of the Owner and Max-Power groups are same.  
<FONT SIZE = 2, COLOR = " #668203"><B>ALTERNATE HYPOTHESIS, H1 : </B></FONT>True Means of the Owner and Max-Power groups are not same.  
...
<FONT SIZE = 2, COLOR = " #A11515"><B>Observation - </B></FONT>
Since, the p-value of our ANOVA test is less than our alpha = 0.05, we can reject the Null Hypothesis of the test. 
This means that we have sufficient evidence to say that True Means of the Owner and Max-Power groups are not same in the data set.  
  
<FONT SIZE = 2, COLOR = " #668203"><B>NULL HYPOTHESIS, H0 : </B></FONT>True Means of the Owner and Engine groups are same.  
<FONT SIZE = 2, COLOR = " #668203"><B>ALTERNATE HYPOTHESIS, H1 : </B></FONT>True Means of the Owner and Engine groups are not same.  
...
<FONT SIZE = 2, COLOR = " #A11515"><B>Observation - </B></FONT>
Since, the p-value of our ANOVA test is not less than our alpha = 0.05, we can not reject the Null Hypothesis of the test. 
This means that we do not have sufficient evidence to say that True Means of the Owner and Engine groups are not same in the data set.   
  
<FONT SIZE = 2, COLOR = " #668203"><B>NULL HYPOTHESIS, H0 : </B></FONT>True Means of the Owner and Mileage groups are same.  
<FONT SIZE = 2, COLOR = " #668203"><B>ALTERNATE HYPOTHESIS, H1 : </B></FONT>True Means of the Owner and Mileage groups are not same.  
...
<FONT SIZE = 2, COLOR = " #A11515"><B>Observation - </B></FONT>
Since, the p-value of our ANOVA test is less than our alpha = 0.05, we can reject the Null Hypothesis of the test. 
This means that we have sufficient evidence to say that True Means of the Owner and Mileage groups are not same in the data set.  
  
<FONT SIZE = 2, COLOR = " #668203"><B>NULL HYPOTHESIS, H0 : </B></FONT>True Means of the Owner and Kilometers-Driven groups are same.  
<FONT SIZE = 2, COLOR = " #668203"><B>ALTERNATE HYPOTHESIS, H1 : </B></FONT>True Means of the Owner and Kilometers-Driven groups are not same.  
...
<FONT SIZE = 2, COLOR = " #A11515"><B>Observation - </B></FONT>
Since, the p-value of our ANOVA test is less than our alpha = 0.05, we can reject the Null Hypothesis of the test. 
This means that we have sufficient evidence to say that True Means of the Owner and Kilometers-Driven groups are not same in the data set.  


# Regression Model
  
Linear regression models the relationship between two variables by fitting a linear equation to observed data. One variable is considered to be an explanatory variable, and the other is considered to be a dependent variable. Linear regression uses the equation y = B0 + B1*x to model the data. We are going to model the price of the cars listed on CarDekho.com with the other variables. 
  
## Assumptions of Linear Model
  
Before building a linear regression model, these assumptions need to be verified:
...
The lm() function is used to build the linear regression model. However, to obtain the best model, we have used an approach called stepwise linear regression. Stepwise linear regression is a method of regressing multiple variables while simultaneously removing those that aren't important. Stepwise regression essentially does multiple regression a number of times, each time removing the weakest correlated variable. At the end we are left with the variables that explain the distribution best.
