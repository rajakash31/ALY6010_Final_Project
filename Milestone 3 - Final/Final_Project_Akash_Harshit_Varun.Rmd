...
```{r path, echo=FALSE}
setwd("/Users/HarshitGaur/Documents/Northeastern University/MPS Analytics/ALY 6010/Final Project/Milestone 3 - Final/")
```
...
ggplot(data = car_sales, aes(x = km_driven, y = selling_price, color = transmission)) +
  geom_point() +
  geom_jitter() +
  labs(title = "Scatter Plot of Cars' Kilometers Driven vs Selling Price", x = "Brands", y = 'Selling Price') +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size = 10)) + 
  geom_smooth(method = "lm")
